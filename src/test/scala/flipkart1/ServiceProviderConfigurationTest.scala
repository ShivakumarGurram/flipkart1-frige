...
import flipkart1.reader.mycomponent.MyStreamReaderImpl
import flipkart1.transformer.mycomponent.MyStreamTransformerImpl
import flipkart1.writer.mycomponent.MyStreamWriterImpl
